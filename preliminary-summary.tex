...
and $\epsilon_{v \vb{k}} < 0$ is the valence band energy from the Fermi energy.
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{figs/exciton-trion-comparison.pdf}
    \caption{Comparison between exciton signatures and trion signatures. 
    (a), (b) Exciton ARPES signatures at $Q_x = \text{\SI{0}{\angstrom} and \SI{0.5}{\angstrom}}$.
    (c), (d) Exciton ARPES signatures at $Q_x = \text{\SI{0}{\angstrom} and \SI{0.5}{\angstrom}}$. 
    The binding energy of the trion mode is manually shifted to
    the exciton binding energy in \cite{rustagi2018photoemission}, 
    but significant differences can still be spotted 
    between exciton and trion signatures.}
