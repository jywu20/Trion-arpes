...
E_residue_correction = exciton.E_B
...
let 
    ...
    Akω_total = trion_ARPES_ehh(trion, P, k1_grid, k1_list, ω_list, Ak1k2, broaden, E_residue_correction)
    ...
    lines!(ax, [binding_starting_bar_pos - binding_starting_bar_width, binding_starting_bar_pos + binding_starting_bar_width], [exciton.E_g, exciton.E_g], color=:black)
    arrows!(ax, [binding_starting_bar_pos], [trion.E_g], [0.0], [-trion.E_B - exciton.E_B], color=:black, arrowsize=10)
...
save("ehh-display-very-compact-2-residue-energy-ionization.png", f)
f