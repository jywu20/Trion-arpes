...
ω = let k_1 = (trion.m_e / M * (P - w) - k) / 2
    mom_report = momentum_calc_ehh(trion, P, k, k_1)
    k_h1 = mom_report.k_h1
    k_h2 = mom_report.k_h2
...
save("ehh-ring-and-peak-contribution-k12-equal-example.png", f)
f
