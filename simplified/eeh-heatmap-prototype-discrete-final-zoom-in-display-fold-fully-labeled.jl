...
let f = Figure(size=(600, 400))
    ...
    text!(ax, w_side / 8, E_g + 0.03, text="unlike-spin, \n A, Q=K")
    text!(ax, w_side / 4, 2E_g - trion.E_B - minimum(eig_matrix_0[1, :]), text="1s")
    text!(ax, w_side / 4, 2E_g - trion.E_B - minimum(eig_matrix_0[3, :]) - 0.04, text="2p")
    text!(ax, w_side / 4, 2E_g - trion.E_B - minimum(eig_matrix_0[7, :]) - 0.04, text="2s")

    text!(ax, w_side / 2, E_g + 0.03, text="unlike-spin, \n A, Q=K")
    text!(ax, 3w_side / 4, 2E_g - trion.E_B - minimum(eig_matrix_K[1, :]), text="1s")
    text!(ax, 3w_side / 4, 2E_g - trion.E_B - minimum(eig_matrix_0[3, :]) - 0.04, text="2p")
    text!(ax, 3w_side / 4, 2E_g - trion.E_B - minimum(eig_matrix_0[7, :]) - 0.04, text="2s")
    ...
    save("eeh-heatmap-prototype-discrete-final-zoom-in-display-fold.png", f)
