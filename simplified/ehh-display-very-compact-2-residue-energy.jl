...
let 
    ...
    text!(ax, binding_starting_bar_pos + binding_annotation_displacement, trion.E_g - trion.E_B - exciton.E_B / 2, text=rich("E", subscript("repulsion", font=:regular), font=:italic)) 
...
save("ehh-display-very-compact-2-residue-energy.png", f)
f