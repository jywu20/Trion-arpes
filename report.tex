...
\begin{column}{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figs/exciton-Q-0.0.png}
    Single exciton, $\vb{Q} = \SI{0.0}{\angstrom^{-1}}$
\end{column}
    
\begin{column}{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figs/exciton-Q-0.5.png}
...
\begin{column}{0.4\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figs/exciton-beta-10.png}
    Thermalized exciton, $\beta = \SI{10}{eV}$
\end{column}
    
\begin{column}{0.4\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figs/exciton-beta-100.png}
...
\begin{center}
    \includegraphics[width=0.4\textwidth]{figs/exciton-Q-0.7-w-0.7.png}
    \includegraphics[width=0.4\textwidth]{figs/trion-P-0.7-w-0.7.png}
\end{center}    
...
\begin{center}
    \includegraphics[width=0.4\textwidth]{figs/exciton-Q-1.2-w-0.7.png}
    \includegraphics[width=0.4\textwidth]{figs/trion-P-1.2-w-0.7.png}
\end{center}
...
\begin{center}
    \includegraphics[width=0.4\textwidth]{figs/exciton-β-10-w-0.7.png}
    \includegraphics[width=0.4\textwidth]{figs/trion-β-10-w-0.7.png}
\end{center}    
