...
\begin{equation}
    \begin{aligned}
        ...
        &\ \  + \underbrace{
            \frac{\vb{k}_1^2}{2\mu} + \frac{\vb{k}_2^2}{2\mu} + \frac{\vb{k}_1 \cdot \vb{k}_2}{2\me}
...
The trion wave function therefore assumes the following form: 
\begin{equation}
...
\begin{equation}
    \begin{aligned}
    H &= \frac{\kei{1}^2}{2\me} + \frac{(\kei{2} - \vb{w})^2}{2\me} + \frac{\kh^2}{2\mh} \\
...
and the dispersion relation is 
\begin{equation}
    \omega = E_{\text{bind}} - \frac{\kp^2}{2\me} - \frac{(2 \kp + \vb{w} - \vb{P})^2}{2\mh}, 
\end{equation}
