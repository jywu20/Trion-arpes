...
\section{Two-band model for a positive trion}
...
We start with the following Hamiltonian of a negative trion, 
i.e. a trion that contains one electron and two holes (ehh).
...
\begin{equation}
    \begin{aligned}
        ...
        &\ \  + \underbrace{
            \frac{\vb{k}_1^2 + \vb{k}_2^2}{2\mu} + \frac{\vb{k}_1 \cdot \vb{k}_2}{\me}
...
\begin{figure*}
    ...
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\textwidth]{figs/exciton-Q-0.2-w-0.0-makie.png}      
        \subcaption{}
    \end{subfigure}
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\textwidth]{figs/trion-e1h1h2-P-1.2-w-1.0-makie.png}
        \subcaption{}
    \end{subfigure}
    \caption{The simulated ARPES spectra of the exciton (a) and the ehh trion (b). 
    Effective masses and the band gap are from Ref. \cite{qiu2013optical}.
    The curvatures of the two signals are different, 
    and so are the center of them.}
\end{figure*}
...
\end{equation}
We note that the effective mass of this dispersion relation is $2 \mh$ instead of $\mh$,
meaning that the ARPES signature does not have a well-defined curvature corresponding to an effective mass of $\mh$.
Moreover, the center of the ARPES signature is predicted to be 
\begin{equation}
    \ke = \frac{\me}{M} (\vb{P} - \vb{w}),
\end{equation}
different from 
...
\begin{equation}
    \begin{aligned}
        ...
        &\ \  + \underbrace{
            \frac{\vb{k}_1^2}{2\mu} + \frac{\vb{k}_2^2}{2\mu} + \frac{\vb{k}_1 \cdot \vb{k}_2}{\mh}
            + V(\vb{r}_1 - \vb{r}_2) - V(\vb{r}_1) - V(\vb{r}_2)
        }_{H_{\text{internal}}},
    \end{aligned}
\end{equation}
...
\end{equation}
while the effective mass is  TODO: an analytic expression giving the shape of the signature is still elusive

\begin{figure}
    \includegraphics[width=0.4\textwidth]{figs/trion-e1e2h1-P-1.0-w-1.0-makie.png}
    \caption{The simulated ARPES spectrum of the eeh trion. Effective masses and the band gap are from Ref.~\cite{qiu2013optical}.}
\end{figure}
...
\bibliography{arpes,trion,materials}
